...
template<typename T>
CUresult wait_on_value(CUstream stream_handle, CUresult address, T value, unsigned int flags);

template<typename T>
CUresult write_value(CUstream stream_handle, CUresult address, T value, unsigned int flags);
...
template<>
inline CUresult wait_on_value<uint32_t>(CUstream stream_handle, CUresult address, uint32_t value, unsigned int flags)
{
    return cuStreamWaitValue32(stream_handle, address, value, flags);
}

template<>
inline CUresult wait_on_value<uint64_t>(CUstream stream_handle, CUresult address, uint64_t value, unsigned int flags)
{
...
template<>
inline CUresult write_value<uint32_t>(CUstream stream_handle, CUresult address, uint32_t value, unsigned int flags)
{
    return cuStreamWriteValue32(stream_handle, address, value, flags);
}

template<>
inline CUresult write_value<uint64_t>(CUstream stream_handle, CUresult address, uint64_t value, unsigned int flags)
{
